...
void therm(double * vx, double * vy, double * vz,
	    int n, double T0, double * KE){
    double T=(*KE)/n*2./3.;
...
int main ( int argc, char * argv[] ) {
  ...
  fprintf(stdout,"# L = %.5lf; rho = %.5lf; pcorr = %.5lf; N = %i; rc = %.5lf\n",
	  L,rho,pcor,N,sqrt(rc2));
